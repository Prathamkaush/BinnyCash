...
const GoldCoinIcon = ({ className = "w-6 h-6" }: { className?: string }) => (
  <svg className={className} viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
    <circle cx="12" cy="12" r="10" fill="url(#coinGradDemo)" stroke="#d97706" strokeWidth="1.5" />
    ...
    <defs>
      <linearGradient id="coinGradDemo" x1="4" y1="4" x2="20" y2="20" gradientUnits="userSpaceOnUse">
...
export default function InteractiveDemo({ onStartEarning, language = "en" }: InteractiveDemoProps) {
  ...
  return (
    <section id="demo" className="relative w-full py-20 px-4 md:px-6 bg-bg-secondary/30 border-y border-card-border/20 overflow-hidden">
      
      {/* Background Glowing Accents */}
      <div className="absolute -bottom-40 left-1/4 w-[550px] h-[450px] bg-accent-green/10 rounded-full blur-[120px] pointer-events-none" />
      <div className="absolute -top-20 right-10 w-[450px] h-[450px] bg-accent-purple/5 rounded-full blur-[110px] pointer-events-none" />
      ...
      <div className="max-w-7xl mx-auto relative z-10">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-8 items-center">
          ...
          <div className="lg:col-span-7 flex flex-col gap-6 text-center lg:text-left items-center lg:items-start">
            ...
            <div className="inline-flex items-center gap-2.5 px-4 py-2 rounded-full bg-[#130f26]/85 border border-[#10b981]/25 text-xs font-semibold text-text-primary tracking-wide shadow-lg backdrop-blur-sm">
              <Sparkles className="w-3.5 h-3.5 text-accent-green fill-accent-green animate-pulse" />
              <span className="text-accent-green uppercase tracking-widest text-[10px]">
                {t.steps_badge}
              </span>
            </div>

            {/* Heading - Dynamic tasks */}
            <h2 className="text-3xl md:text-5xl font-black font-display text-text-primary leading-tight">
              {t.step2_title} <br className="hidden sm:inline" />
              <span className="bg-gradient-to-r from-accent-green to-accent-purple bg-clip-text text-transparent inline-block border-r-3 border-accent-purple pr-1.5 animate-caret mt-1">
                {typedText}
              </span>
            </h2>
            ...
            <p className="text-base md:text-lg text-text-secondary max-w-xl leading-relaxed">
              {t.step2_desc} Experience the seamless app flow with our simulated game task below. Follow requirements to trigger cash rewards instantly.
            </p>
            ...
            <div className="flex flex-col sm:flex-row items-center gap-4 w-full sm:w-auto mt-2">
              <button
                ...
                className="w-full sm:w-auto px-8 py-4 bg-gradient-to-r from-accent-green to-accent-purple hover:opacity-90 text-white font-bold rounded-2xl shadow-glow-green transition-all duration-300 transform hover:-translate-y-0.5 cursor-pointer flex items-center justify-center gap-2"
              >
          ...
          <div className="lg:col-span-5 flex justify-center items-center relative py-10 lg:py-4">
            <div className="relative w-full max-w-[310px] aspect-[9/18.5] select-none">
              ...
              <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[380px] h-[380px] bg-accent-green/15 rounded-full blur-[100px] pointer-events-none" />
              <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[240px] h-[240px] bg-accent-purple/10 rounded-full blur-[70px] pointer-events-none" />

              {/* Floating Badge: Reward Credited */}
              <div className="absolute -top-6 -left-12 z-20 backdrop-blur-md bg-[#130f26]/85 border border-accent-purple/20 rounded-2xl p-3.5 shadow-2xl flex items-center gap-3 animate-bounce-slow">
              ...
              {/* Floating Badge: Complete Survey */}
              <div className="absolute top-1/4 -right-12 z-20 backdrop-blur-md bg-[#120e21]/85 border border-[#8b5cf6]/20 rounded-2xl p-3.5 shadow-2xl flex items-center gap-3 animate-float-slow">
              ...
              {/* Floating Badge: Play & Earn */}
              <div className="absolute bottom-[16%] -left-14 z-20 backdrop-blur-md bg-[#120e21]/85 border border-accent-green/20 rounded-2xl p-3.5 shadow-2xl flex items-center gap-3 animate-float-delayed">
              ...
              <div className="relative w-full h-[580px] bg-[#09070f] border-4 border-[#1b1532] rounded-[44px] shadow-[0_20px_50px_rgba(0,0,0,0.8)] overflow-hidden flex flex-col p-3.5">
                ...
                <div className="relative w-full h-full bg-[#0c0915] rounded-[32px] overflow-hidden flex flex-col pt-8 pb-4 px-3.5 border border-white/5">
                  ...
                  <div className="flex items-center justify-between mt-1 mb-4">
                    <span className="text-xs font-bold text-text-primary">Runner Game Preview</span>
                  ...
                  <div className="bg-bg-tertiary/60 border border-card-border rounded-2xl p-4 flex flex-col items-center gap-1.5 text-center relative overflow-hidden mb-4">
                    ...
                    <div className="grid grid-cols-4 gap-1 w-full border-t border-b border-white/5 py-2.5 my-1.5 text-center">
                      <div>
                        ...
                        <p className="text-[9px] font-bold text-amber-500">Demo Active</p>
                      </div>
                      <div>
                      ...
                      <div>
                        ...
                        <p className="text-[9px] font-bold text-accent-purple">BinnyCore</p>
                      </div>
                    </div>

                    {/* CTA button inside phone */}
                    <button onClick={onStartEarning} className="w-full py-2.5 rounded-xl bg-gradient-to-r from-accent-green to-accent-purple hover:opacity-90 text-white text-xs font-bold flex items-center justify-center gap-2 shadow-glow-green border border-white/10 cursor-pointer">
